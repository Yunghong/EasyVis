...
bool loadOBJ(
	...
	while( 1 ){
		...
		if ( strcmp( lineHeader, "v" ) == 0 ){
			...
			allVertices.push_back({vertex.x, vertex.y, vertex.z});
	...
	std::cout<<"temp_vertices: "<<temp_vertices.size()<<std::endl;
	std::cout<<"out_vertices: "<<out_vertices.size()<<std::endl;
	std::cout<<"out_uvs: "<<out_uvs.size()<<std::endl;
	std::cout<<"out_normals: "<<out_normals.size()<<std::endl;
	fclose(file);
	return true;
}
